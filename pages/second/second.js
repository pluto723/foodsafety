...
function initChart(canvas, width, height, dpr) {
  ...
  chart.on('click', function (nodes) {
    ...
    for (var index in app.globalData.information) {
      if (app.globalData.information[index].Ingredient == nodes.data.name) {
        let show_information = app.globalData.information[index].Quality + app.globalData.information[index].Quality1
        page.setData({
